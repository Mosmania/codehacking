...
{{--Met gulp en dan samengevoegd in libs.js werkt niet !?!?, dus maar even los--}}
{{--<script src="{{asset('xxx-js/bootstrap.js')}}"></script>--}}
{{--<script src="{{asset('xxx-js/bootstrap.min.js')}}"></script>--}}
{{--<script src="{{asset('xxx-js/jquery.js')}}"></script>--}}
{{--<script src="{{asset('xxx-js/metisMenu.js')}}"></script>--}}
{{--<script src="{{asset('xxx-js/sb-admin-2.js')}}"></script>--}}
{{--<script src="{{asset('xxx-js/scripts.js')}}"></script>--}}
